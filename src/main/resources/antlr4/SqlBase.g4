...
statement
    ...
    | INSERT insertType=(INTO | OVERWRITE) qualifiedName columnAliases? query     #insert
...
queryNoWith:
      ...
      (CLUSTER BY expression (',' expression)*)?
      (DISTRIBUTE BY expression (',' expression)*)?
...
// workaround for https://github.com/com.yogafire.sql.changer.antlr/antlr4/issues/780
