...
public abstract class AstVisitor<R, C> {
    ...
    protected R visitClusterBy(ClusterBy node, C context) {
        return visitNode(node, context);
    }

    protected R visitDistributeBy(DistributeBy node, C context) {
        return visitNode(node, context);
    }

    protected R visitSortBy(SortBy node, C context) {
        return visitNode(node, context);
    }
