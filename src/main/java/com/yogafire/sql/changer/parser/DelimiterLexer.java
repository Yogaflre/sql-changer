 ...
 * <p>
 * The code in nextToken() is a copy of the implementation in org.com.yogafire.sql.changer.antlr.v4.runtime.Lexer, with a
        ...
        try {
            ...
            while (true) {
                ...
                do {
                    ...
                    // This entire method is copied from org.com.yogafire.sql.changer.antlr.v4.runtime.Lexer, with the following bit
