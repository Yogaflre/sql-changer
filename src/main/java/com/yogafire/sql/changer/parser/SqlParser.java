...
import com.yogafire.sql.changer.antlr4.SqlBaseBaseListener;
...
import com.yogafire.sql.changer.tree.Return;
...
import static com.yogafire.sql.changer.parser.SqlParserOptions.RESERVED_WORDS_WARNING;
...
public class SqlParser {
    ...
    private class PostProcessor
        ...
        public void exitNonReserved(SqlBaseParser.NonReservedContext context) {
            // we can't modify the com.yogafire.sql.changer.tree during rule enter/exit event handling unless we're dealing with a terminal.
