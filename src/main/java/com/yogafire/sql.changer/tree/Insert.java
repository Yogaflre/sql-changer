...
public final class Insert
    ...
    public Insert(InsertType type, QualifiedName target, Optional<List<Identifier>> columns, Query query) {
        this(type, Optional.empty(), columns, target, query);
    }

    private Insert(InsertType type, Optional<NodeLocation> location, Optional<List<Identifier>> columns, QualifiedName target, Query query) {
        super(location);
        this.type = type;
